            ...
            <section className="basis-3/5 h-full bg-white flex flex-col">
                ...
                <form action="" method="post">
                  <fieldset className="w-2/5 flex flex-col">
                    ...
                    <label
                      ...
                      className="flex-1 text-sm font-medium text-gray-700 space-y-6"
                    >
                      Equipment Name
                    </label>
                    <input
                    ...
                    <div className="flex flex-row flex-1 gap-x-2 justify-center">
                      <button
                        type="submit"
                        className="p-1 text-sm border border-gray-600 shadow-sm"
                      >
                        Add Item
                      </button>
                      <button
              ...
              <aside className="flex flex-col basis-3/5 w-full text-black bg-white border border-solid border-black px-6 py-3 gap-y-3">
                ...
                <table className="min-w-full border-collapse border border-gray-900">
                  <thead>
                    <tr>
                      <th className="font-normal text-sm border border-gray-900 text-left px-2 py-1">
                        Equipment Name
                      </th>
                      <th className="font-normal text-sm border border-gray-900 text-left px-2 py-1">
                        Booked By
                  ...
                  <tbody>
                    <tr>
                      <td className="text-sm border border-gray-900 px-2 py-1">
                        equipment1
                      </td>
                      <td className="text-sm border border-gray-900 px-2 py-1">
                        booked1
